...
Backend Python developer with experience in **Django**, **FastAPI**, and **SQL**, currently transitioning into **Data Analytics**.

I have designed and queried relational databases using PostgreSQL across multiple real-world projects, cleaned and transformed datasets with Pandas, and created data visualizations using Tableau.

My goal is to turn raw data into actionable business insights through analytics and visualization.
